...
di "`*'"
while "`*'"~="" {
	cap findfile pof2017_`1'.dct
	if _rc==601 findfile pof2017_`1'_en.dct
...
di _newline "This version of the package datazoom_poftrs_17 is compatible with the POF 2017/2018 released in 25/11/2020"
