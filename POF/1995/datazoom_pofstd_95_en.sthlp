...
{viewerjumpto "Syntax" "datazoom_pofstd_95##syntax"}{...}
{viewerjumpto "Description" "datazoom_pofstd_95##description"}{...}
{viewerjumpto "Options" "datazoom_pofstd_95##options"}{...}
{viewerjumpto "Remarks" "datazoom_pofstd_95##remarks"}{...}
{viewerjumpto "Examples" "datazoom_pofstd_95##examples"}{...}
{title:Title}

{phang}
{bf:datazoom_pofstd_95} {hline 2} Access to STATA format POF 1995-96 Standard Databases - Version 1.2

{marker syntax}{...}
{title:Syntax}
{p 8 17 2}
{cmdab:datazoom_pofstd_95}
[{cmd:,}
{it:options}]
...
{phang}
{cmd:datazoom_pofstd_95} extracts and constructs a standard database of POF 1995-96 from 
...
is part of POF 1995-96 package, which also contains {help datazoom_poftrs_95} 
and {help datazoom_pofsel_95} (these programs
...
on cereals, pulses and oilseeds. This aggregation follows IBGE POF documentation. 
...
household characteristics. And if Individual is chosen, variables pertaining individual 
...
{opt original(string)}  indicates the path of the folder where the original data files are located.
 All twelve files must be located
...
{phang}  NOTE: In order to facilitate the command use, type "db datazoom_pof1995" on the command window.

{phang} datazoom_pofstd_95, id(uc pess ) original(c:/mydata) saving(c:/pof)
