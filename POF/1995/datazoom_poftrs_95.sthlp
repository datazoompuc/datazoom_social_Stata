...
{phang}
{bf:datazoom_poftrs_95} {hline 2}  Acesso às bases da POF 1995-96 em formato STATA - Versão 1.2
...
{phang}
{cmd:datazoom_poftrs_95} extrai bases de dados da POF 1995-96 em formato STATA (.dta) a partir dos microdados originais, 
os quais não são disponibilizados pelo Portal (informações sobre como obter os arquivos originais de dados, consulte o
        site do IBGE www.ibge.gov.br). Este programa é parte do pacote POF 1995-96, que inclui {help datazoom_pofstd_95} e
		{help datazoom_pofsel_95} (todos os programas são independentes uns dos outros).
		
{phang} Este programa auxilia o usuário a ter acesso aos 12 tipos de registros existentes na POF 1995-96, sem que haja
...
{phang} datazoom_poftrs_95, trs(tr1 tr6 tr12) original(c:/mydata) saving(c:/pof)
...
{phang}  OBS: Recomenda-se a execução do programa por meio da caixa de diálogo. Digite "db
        datazoom_pof1995" na janela de comando do STATA para iniciar.
...
For the english version, type "net from www.econ.puc-rio.br/datazoom/english".
