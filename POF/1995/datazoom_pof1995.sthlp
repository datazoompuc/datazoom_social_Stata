...
{phang}
{bf:datazoom_pof1995} {hline 2}  Acesso aos microdados da POF 1995-96 em formato STATA - Versão 1.2
...
{phang}
{cmd:datazoom_pof1995} é um pacote composto por três comandos.

{phang}
1) datazoom_pofstd_95: execute este comando para obter um base padronizada da POF 1995-96 standard database. 
Esta base contém variáveis de gasto/aquisição para uma cesta de consumo pré-definida com itens agredados, 
seguinto uma classificação disponibilizada pelo IBGE. Para mais informações ver {help datazoom_pofstd_95}.

{phang}
2) datazoom_pofsel_95: com este comando o usuário obtém uma base de dados persoanalizada, com as variáveis
 relacionadas aos itens escolhidos pelo próprio usuário. Para mais informações ver {help datazoom_pofsel_95}.
	
{phang}
3) datazoom_poftrs_95: execute este comando para obter as bases de dados originais em formato STATA sem manipulações
 de variáveis. A POF 1995-96 contém 12 tipos de registros. Para mais informações ver {help datazoom_poftrs_95}.
...
{phang}
Digite "db datazoom_pof1995" na janela de comando para iniciar.
