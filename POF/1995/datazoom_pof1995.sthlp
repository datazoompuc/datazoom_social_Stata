{smcl}
{viewerdialog "POF 1995" "dialog datazoom_pof1995"}
...
{viewerjumpto "Syntax" "datazoom_pof1995##syntax"}{...}
{viewerjumpto "Description" "datazoom_pof1995##description"}{...}
{viewerjumpto "Options" "datazoom_pof1995##options"}{...}
{viewerjumpto "Examples" "datazoom_pof1995##examples"}{...}
{p 8 8 2} {it:For the English version}, {help datazoom_pof1995_en}

{title:Title}

{p 4 4 2}
{cmd:datazoom_pof1995} {hline 2} Acesso aos microdados da POF 1995-96
...
Digite {cmd:db datazoom_pof1995} para utilizar a função via caixa de diálogo.
...
{p 4 4 2}
{cmd: datazoom_poftrs_95} produz as bases de dados originais em formato Stata sem manipulações
...
{p 8 6 2}. datazoom_pofsel_95, id(uc) original("~/mydata") saving("~/mydata") lista(frutas farinha_de_trigo açúcar_refinado)

{p 6 6 2}
Base final contém gastos anualizados em frutas, farinha de trigo e açúcar refinado para unidades de consumo.
...
{p 8 6 2}. datazoom_pofsel_95, id(dom) original("~/mydata") saving("~/mydata") lista(Feijao Cenoura Roupa_de_crianca Transferencia)

{p 6 6 2}
base final contém gastos anualizados com feijão, cenoura e roupa de criança, além de rendimentos recebidos 
...
{p 8 6 2}.datazoom_poftrs_95, trs(tr1 tr6 tr12) original("~/mydata") saving("~/mydada")

{p 6 6 2}
A execução do exemplo acima gera três bases de dados, uma para cada tipo de registro especificado 
(1 - Domicílio; 6 - Outras Despesas; 12 - Outros Rendimentos). As três bases serão salvas na pasta
"~/mydata".
