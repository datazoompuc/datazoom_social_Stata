...
{phang}
{bf:datazoom_pofstd_02} {hline 2} Acesso à bases padronizadas da POF 2002-03 em formato STATA - Versão 1.2
...
{phang}
{cmd:datazoom_pofstd_02} extrai e constrói uma base de dados padronizada da POF 2002-03 a partir dos microdados originais, 
...
{phang} Nesta base padronizada, o gasto em itens semelhantes são agregados em um único
		 ...
		 (consulte "Tradutores"). Todas as agregações existentes naquele documento
		  ...
		  de itens diferentes das existentes. Todos os valores são anualizados e deflacionados para janeiro/2003.
