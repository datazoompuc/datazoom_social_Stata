...
{viewerjumpto "Description" "datazoom_pof2008##description"}{...}
{title:Title}

{phang}
{bf:datazoom_pof2008} {hline 2}  Acesso aos microdados da POF 2008-09 em formato STATA - Versão 1.2
...
{phang}
{cmd:datazoom_pof2008} é um pacote composto por três comandos.

{phang}
1) datazoom_pofstd_08: execute este comando para obter um base padronizada da POF 2008-09 standard database. 
Esta base contém variáveis de gasto/aquisição para uma cesta de consumo pré-definida com itens agredados, 
seguinto uma classificação disponibilizada pelo IBGE. Para mais informações ver {help datazoom_pofstd_08}.

{phang}
2) datazoom_pofsel_08: com este comando o usuário obtém uma base de dados persoanalizada, com as variáveis
 relacionadas aos itens escolhidos pelo próprio usuário. Para mais informações ver {help datazoom_pofsel_08}.
	
{phang}
3) datazoom_poftrs_08: execute este comando para obter as bases de dados originais em formato STATA sem manipulações
 de variáveis. A POF 2008-09 contém 16 tipos de registros. Para mais informações ver {help datazoom_poftrs_08}.
...
{phang}
Digite "db datazoom_pof2008" na janela de comando para iniciar.


{title:Sobre a POF 2008-09}
...
ao domicílio (como consumo de eletricidade) ou ao indivíduo (lanches fora do domicílio). Tanto a periodicidade quanto a
 ...
 meio de uma caderneta preenchida diariamente pelo domicílio durante sete dias. Por sua vez, os gastos com serviço de cabeleireiro
