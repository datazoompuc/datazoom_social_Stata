...
{title:Title}
{phang}
{bf:datazoom_pof2008} {hline 2}  Access to STATA format POF 2008-09 databases - Version 1.2
...
{phang}
{cmd:datazoom_pof2008} is composed of three programs.

{phang}
1) datazoom_pofstd_08: run this program to get a POF 2008-09 standard database. It contains
	expenditure/acquisition variables for aggregate items according to IBGE classification.
	For more information, check {help datazoom_pofstd_08}

{phang}
2) datazoom_pofsel_08: through this program the user can construct his own database by choosing 
	and adding disaggregated items into a basket. For more information, check {help datazoom_pofsel_08}
	
{phang}
3) datazoom_poftrs_08: run this program to extract STATA format POF 2008-09 databases from
	original files whithout any manipulation. 2008-09 version contains 16 types of register.
	For more information, check {help datazoom_poftrs_08}
...
{phang}
Type "db datazoom_pof2008" on the command window to start.

{title: About the POF 2008-09}
...
The above-cited programs (specially datazoom_pofstd_08 and datazoom_pofsel_08) aim to aid the user's access to this survey.
